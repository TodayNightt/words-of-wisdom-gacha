...
export default function Dashboard() {
	...
	return (
		<>
			<ErrorBoundary fallback={<ErrorPage path="/admin" />}>
				<Title>Dashboard</Title>
				<nav class="p-4 flex items-center w-full h-[100px] justify-between box-border">
					<h1 class="text-4xl font-bold p-2 text-ellipsis">
						Words of Wisdom Dashboard
					</h1>
					<Button
						onClick={logoffAction}
						tailwindClass="sm:mx-2 sm:px-2 flex gap-2 items-center min-w-[6rem]"
					>
						<ImExit class="size-5" />
